...
function AdminSplash() {
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center gap-3 overflow-hidden bg-[radial-gradient(circle_at_18%_15%,rgba(108,248,187,0.42),transparent_28%),radial-gradient(circle_at_82%_18%,rgba(226,223,255,0.78),transparent_32%),radial-gradient(circle_at_70%_82%,rgba(255,218,220,0.58),transparent_34%),linear-gradient(135deg,#f8f9ff_0%,#dce9ff_48%,#f8f9ff_100%)]">
      ...
      <div className="rounded-full border border-white/30 bg-white/25 px-4 py-2 text-sm font-bold text-[#26344a] shadow-[inset_1px_1px_0_rgba(255,255,255,0.62)] backdrop-blur-xl">
