...
const DEFAULTS = {
  ...
  ai_quota: {
    ...
    free_scan_monthly: 3,
    short_scan_monthly: 200,
    short_insight_daily: 30,
    short_telegram_daily: 500,
    short_whatsapp_daily: 500,
    annual_scan_monthly: 200,
    annual_insight_daily: 30,
    annual_telegram_daily: 500,
    annual_whatsapp_daily: 500,
  },
  pricing: {
    promo_start_date: null,
    promo_days: 30,
    promo_max_users: { annual: 500, lifetime: 500 },
    normal: { monthly: 35000, quarterly: 79000, annual: 249000, lifetime: 649000 },
    promo: { annual: 149000, lifetime: 499000 },
  },
  ai_credit: {
    lifetime_grant: { receipt_scan: 480, ai_insight: 1095, telegram_chat: 18250, whatsapp_chat: 10950 },
    topup_grant: { receipt_scan: 240, ai_insight: 546, telegram_chat: 9100, whatsapp_chat: 5460 },
    topup_price: 124500,
  },
  ape_epi: {
    enabled: false,
...
const ALLOWED_FIELDS = {
  ...
  ai_quota: [
    ...
    'short_scan_monthly',
    'short_insight_daily',
    'short_telegram_daily',
    'short_whatsapp_daily',
    'annual_scan_monthly',
    'annual_insight_daily',
    'annual_telegram_daily',
    'annual_whatsapp_daily'
  ],
  pricing: ['promo_start_date', 'promo_days', 'promo_max_users', 'normal', 'promo'],
  ai_credit: ['lifetime_grant', 'topup_grant', 'topup_price'],
...
function envFallback(key) {
  if (key === 'mailketing') {
    return {
      ...
      paid_list_id: process.env.MAILKETING_PAID_LIST_ID || '',
    };
  }
  if (key === 'midtrans') {
