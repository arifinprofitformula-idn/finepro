...
const DEFAULTS = {
  ...
  ai_quota: {
    ...
    free_scan_monthly: 3,
    short_scan_monthly: 20,
    short_insight_daily: 2,
    short_telegram_daily: 30,
    short_whatsapp_daily: 20,
    annual_scan_monthly: 40,
    annual_insight_daily: 3,
    annual_telegram_daily: 50,
    annual_whatsapp_daily: 30,
  },
  pricing: {
    promo_start_date: null,
    promo_days: 30,
    promo_max_users: { annual: 500, lifetime: 500 },
    normal: { monthly: 29000, quarterly: 79000, annual: 249000, lifetime: 649000 },
